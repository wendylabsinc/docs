...
| `/etc/wendyos/device-type` | Persistent (`/data/etc/wendyos/`) | Board identifier string (e.g. `rpi5-sd`, `rpi4-sd`). Seeded from the rootfs on first boot and kept on `/data` thereafter. |
